    ...
    <section className="relative min-h-screen w-full overflow-hidden flex flex-col justify-center items-center px-6 py-20 bg-gradient-radial from-[#0f0b1f] via-navy to-[#050810]">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto">
        ...
        <motion.h2
          ...
          className="font-playfair italic text-white text-[clamp(1.6rem,6vw,3rem)] font-light leading-relaxed max-w-2xl mb-6"
        >
        ...
        >
          <motion.h1
            ...
            className="font-playfair font-bold text-[clamp(2rem,10vw,5rem)] text-gold-gradient glow-text leading-none select-none"
          >
            Happy Birthday
          </motion.h1>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ delay: 1 }}
          className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-24 w-full sm:w-auto px-4"
        >
          {/* WhatsApp button */}
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#20ba5a] text-white px-7 py-3.5 rounded-full text-sm font-medium shadow-lg shadow-[#25d366]/20 transition-colors duration-300 cursor-pointer w-full sm:w-auto"
          >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.04 }}
            whileTap={{ scale: 0.98 }}
            className="flex items-center justify-center gap-2.5 bg-gold/15 hover:bg-gold/25 border border-gold/40 text-gold px-7 py-3.5 rounded-full text-sm font-medium backdrop-blur-sm transition-all duration-300 cursor-pointer w-full sm:w-auto"
          >
            {isCopied ? (
              <>
